...
@Slf4j
@RestController
@RequestMapping(GemModules.Extend.PATH_PRE+"/journaling/termination")
public class TerminationController extends BaseController {
     ...
     */
    @GetMapping("/page")
    @RequiresPermissions("termination:page")
     ...
     */
    @GetMapping("/list")
    @RequiresPermissions("termination:list")
    ...
    @GetMapping("/info")
    @RequiresPermissions("termination:info")
